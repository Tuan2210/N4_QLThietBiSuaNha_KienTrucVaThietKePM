        ...
        <div class="content">
            <ol>
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/">Quản lý người dùng</a>
                </li>
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/">Quản lý sản phẩm</a>
                </li>
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/">Quản lý khách hàng</a>
                </li>
            </ol>
        </div>
    </div>
